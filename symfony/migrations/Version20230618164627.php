 ...
 */
final class Version20230618164627 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX profile_service__parent_id__inx ON profile_service (profile_id)');
        $this->addSql('CREATE INDEX profile_service__service_id__inx ON profile_service (service_id)');
        $this->addSql('CREATE TABLE service (id INT NOT NULL, parent_id INT DEFAULT NULL, title VARCHAR(64) NOT NULL, root INT DEFAULT NULL, lvl INT NOT NULL, lft INT NOT NULL, rgt INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
